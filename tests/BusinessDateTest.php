...
class BusinessDateTest extends TestCase {
    ...
    public function testIsBankHoliday() {
        ...
        $isBankHoliday = \DPRMC\BusinessDate\BusinessDate::isBankHoliday( $bankHoliday );
    ...
    public function testOutOfRangeEasterThrowsException() {
        ...
        $getEaster1899 = \DPRMC\BusinessDate\BusinessDate::getEasterForYear( $easter1899 );
    ...
    public function testSwitchCasesAreIncludedInBankHolidaysByYearArray() {
        $year = 2023;
        $bankHolidays = \DPRMC\BusinessDate\BusinessDate::getBankHolidaysByYear( $year );
    ...
    public function testGetLastBusinessDayOfMonthIsAugThirty2019() {
        ...
        $lastBusinessDayOfMonth = \DPRMC\BusinessDate\BusinessDate::getLastBusinessDayOfTheMonth( $stringDate );
    ...
    public function testInvalidStringDateThrowsException() {
        ...
        $lastBusinessDayOfMonth = \DPRMC\BusinessDate\BusinessDate::getLastBusinessDayOfTheMonth( $invalidStringDate );
    ...
    public function testBusinessDateOffsetDaysAwayIsExpectedBusinessDate() {
        ...
        $businessDate = \DPRMC\BusinessDate\BusinessDate::getBusinessDateThisManyDaysAway( $anchorDate, $offset );
